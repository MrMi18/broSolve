...
//               </Button>
//             </div>
//             <p className="text-blue-100 text-sm mt-1">Update your BroSolve profile information</p>
//           </CardHeader>

//           <CardContent className="p-0 h-full">
//             <div className="max-h-[calc(90vh-140px)] overflow-y-auto p-8 space-y-8">
...
//                   <label className="absolute -bottom-2 -right-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full p-3 cursor-pointer hover:from-blue-700 hover:to-purple-700 transition-all duration-300 hover:scale-110 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
//                     {uploadingImage ? (
...
//                       className="border-2 border-gray-200 focus:border-blue-500 rounded-xl transition-all duration-200 h-12"
//                       disabled={saving}
//                     />
...
//                     maxLength={160}
//                     className="resize-none border-2 border-gray-200 focus:border-blue-500 rounded-xl transition-all duration-200 min-h-[100px]"
//                     disabled={saving}
//                     rows={4}
//                   />
...
//                   </p>
//                   <div className="max-h-48 overflow-y-auto p-4 bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-xl border-2 border-gray-200">
