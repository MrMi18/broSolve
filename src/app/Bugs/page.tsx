...
import { collection, query, orderBy, limit, getDocs, startAfter, DocumentData, Timestamp } from 'firebase/firestore'
...
export default function FeedPage() {
  ...
  // Remove useCallback from fetchBugs to avoid dependency issues
  const fetchBugs = async (isLoadMore = false) => {
    try {
      if (isLoadMore) {
        ...
        setLoading(true)
        // Reset lastDoc when not loading more (fresh fetch)
        setLastDoc(null)
      }
      ...
      toast.error("Unable to fetch the bugs!")
  ...
  // Use useCallback for the initial fetch function to prevent re-renders
